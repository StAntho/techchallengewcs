...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd77d1 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer647a0 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesc368b = [
        
    ];

    public function getConnection()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getConnection', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getMetadataFactory', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getExpressionBuilder', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'beginTransaction', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getCache', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getCache();
    }

    public function transactional($func)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'transactional', array('func' => $func), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->transactional($func);
    }

    public function commit()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'commit', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->commit();
    }

    public function rollback()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'rollback', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getClassMetadata', array('className' => $className), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'createQuery', array('dql' => $dql), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'createNamedQuery', array('name' => $name), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'createQueryBuilder', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'flush', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'clear', array('entityName' => $entityName), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->clear($entityName);
    }

    public function close()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'close', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->close();
    }

    public function persist($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'persist', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'remove', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'refresh', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'detach', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'merge', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getRepository', array('entityName' => $entityName), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'contains', array('entity' => $entity), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getEventManager', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getConfiguration', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'isOpen', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getUnitOfWork', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getProxyFactory', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'initializeObject', array('obj' => $obj), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'getFilters', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'isFiltersStateClean', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'hasFilters', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return $this->valueHolderd77d1->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer647a0 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd77d1) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd77d1 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd77d1->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__get', ['name' => $name], $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        if (isset(self::$publicPropertiesc368b[$name])) {
            return $this->valueHolderd77d1->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd77d1;
    ...
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;
    ...
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__isset', array('name' => $name), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;
    ...
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__unset', array('name' => $name), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;
    ...
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__clone', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        $this->valueHolderd77d1 = clone $this->valueHolderd77d1;
    }

    public function __sleep()
    {
        $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, '__sleep', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;

        return array('valueHolderd77d1');
    }
    ...
    {
        $this->initializer647a0 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer647a0;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer647a0 && ($this->initializer647a0->__invoke($valueHolderd77d1, $this, 'initializeProxy', array(), $this->initializer647a0) || 1) && $this->valueHolderd77d1 = $valueHolderd77d1;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd77d1;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd77d1;
    }
}
